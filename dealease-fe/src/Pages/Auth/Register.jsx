    ...
    <main>
      <div>
        ...
        >
          ...
          <Tab.Container defaultActiveKey='home' id='fill-tab-example' fill>
            <Nav fill className='nav-head-reg mt-4'>
              <Nav.Item className='tabs-item'>
                <Nav.Link className='tabs-link' eventKey='home'>
                  Personal Details
                </Nav.Link>
              </Nav.Item>
              <Nav.Item className='tabs-item'>
                <Nav.Link className='tabs-link' eventKey='profile'>
                  Address Details
                </Nav.Link>
              </Nav.Item>
              <Nav.Item className='tabs-item'>
                <Nav.Link className='tabs-link' eventKey='contact'>
                  Account Details
                </Nav.Link>
              </Nav.Item>
            </Nav>
            <Tab.Content className='tab-content-register'>
